			...
			<div class="container">
							...
							<div id="w_carousel" class="carousel slide w_carousel" data-ride="carousel">
								...
								<div class="carousel-inner" role="listbox">
									<div class="item active">
										<img src=${slideInfo.getSlideImg1()} alt="...">
										<div class="carousel-caption">
											<h1>Used ${slideInfo.category} </h1>
											<h3>Explore Desired ${slideInfo.category} in a Cheaper Price!</h3>
										</div>
									</div>
									<div class="item">
										<img src=${slideInfo.getSlideImg2()} alt="...">
										<div class="carousel-caption">
											<h1>Used ${slideInfo.category}</h1>
											<h3>Sell Your Old ${slideInfo.category} in a Desired Price!</h3>
										</div>
									</div>
								</div>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<h3>${topic.title}</h3>
						<ul class="tools">
							<li><span class="glyphicon glyphicon-user" aria-hidden="true">Author:${itemInfo.userName}</span><p></p></li>
							<li><span class="glyphicon glyphicon-eye-open" aria-hidden="true">Reading:${itemInfo.item.readingTimes}</span><p></p></li>
							<c:if test="${!empty itemInfo.comments}">
							  <li><span class="glyphicon glyphicon-comment" aria-hidden="true">Comments:${itemInfo.comments.size()}</span><p></p></li>
							</c:if>
							<c:if test="${empty itemInfo.comments}">
								<li><span class="glyphicon glyphicon-comment" aria-hidden="true">Comments:0</span><p></p></li>
							</c:if>
							<li><span class="glyphicon glyphicon-time" aria-hidden="true">${itemInfo.createTime}</span></li>
						</ul>
						<div class="panel panel-default">
							<div class="panel-body">
								<div class="contentleft">
									<p class="overView">Name: ${itemInfo.item.itemName}</p>
									<p class="overView">Description: ${itemInfo.item.description}</p>
									<p class="overView">Address: ${topic.address}</p>
									<p class="overView">Contact info: ${topic.contact}</p>
									<p class="overView">Price: ${itemInfo.item.price}</p>


									<!-- Favorite -->
									<a id = "hrefForFav" href="/favorite?operation=add&itemId=${itemInfo.item.itemID}&username=${user.userName}" >
									...
									<script>
                                        if(${favExist}){
                                            ...
                                            document.getElementById("hrefForFav").href = "/favorite?operation=delete&itemId=${itemInfo.item.itemID}&username=${user.userName}";
										}
									</script>
...
--%>
													<li><img id="main" src="${itemInfo.item.imagePath}" alt="..." /></li>
<%--
												</c:if>
--%>
											</ul>
									...
									<div class="contentList">
										<div class="panel-body innercontentbox">
											<div class="info">
												...
												<p><span class="glyphicon glyphicon-time" aria-hidden="true"></span>${comment.getValue().getCreateTime()}</p >
											</div>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="leave_comment">
							...
							<form action="/addComments?itemId=${itemInfo.item.itemID}&username=${user.userName}" method="post">
