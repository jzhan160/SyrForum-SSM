        ...
        <div class="panel-body">
            <c:if test="${page != null && page.getTotal() > 0}">
                <table id="items_table">
                    <c:forEach items="${page.list}" var="itemInfo">

                        <div class="contentList">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <h4><a class="title"
                                           href="/item?username=admin&itemId=${itemInfo.item.itemID}">${itemInfo.item.itemName}</a></h4>
                                    <p>
                                        <span class="overView">Author: &nbsp </span><span
                                            class="overView">${itemInfo.userName}</span>

                                        <span><a href="" type="button">&nbsp Delete</a></span>
                                        </span>
                                    </p>
                                </div>
                            </div>
